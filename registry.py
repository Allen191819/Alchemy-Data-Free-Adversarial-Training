...
NORMALIZE_DICT = {
    ...
    'cinic10': dict(mean=[0.478, 0.472, 0.430], std = [0.242, 0.238, 0.258]),
...
MODEL_DICT = {
    ...
    'wrn34_5': classifiers.wresnet.wrn_34_5,
    'wrn34_10': classifiers.wresnet.wrn_34_10,
    ...
    'preactresnet18': classifiers.preactresnet.PreActResNet18,

    'small_cnn_1': classifiers.small_cnn.SmallCNN,
    'small_cnn_2': classifiers.small_cnn.SmallCNN_2,
    'small_fcn_1': classifiers.small_cnn.SmallFCN_1,
    'small_fcn_2': classifiers.small_cnn.SmallFCN_2,
    'resnet8_mnist': classifiers.resnet_tiny.resnet8_M,
    'resnet14_mnist': classifiers.resnet_tiny.resnet14_M,
}
...
def get_dataset(name: str, data_root: str='data', return_transform=False, split=['A', 'B', 'C', 'D']):
    ...
    if name=='mnist':
        ...
        train_dst_1 = datasets.ImageFolder(os.path.join(data_root, 'train'), transform=train_transform)
        train_dst_2 = datasets.ImageFolder(os.path.join(data_root, 'valid'), transform=train_transform)
        train_dst = train_dst_2 + train_dst_1
