...
class DFATCGanSynthesizer(BaseSynthesis):
    def __init__(self, model, nz, num_classes, img_size, 
                 ...
                 iterations=100, lr_g=0.001, progressive_scale=False,
        ...
        super(DFATCGanSynthesizer, self).__init__(model,model)
        ...
        self.generator = datafree.models.generator.DCGAN_CondGenerator(num_classes=num_classes,nz=nz, ngf=64, img_size=img_size[1], nc=3).to(device).train()
