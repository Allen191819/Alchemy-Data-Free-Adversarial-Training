...
def resnet8_M(num_classes):
    return ResNet_M(8, [16, 16, 32, 64], 'basicblock', num_classes=num_classes)


def resnet14_M(num_classes):
    return ResNet_M(14, [16, 16, 32, 64], 'basicblock', num_classes=num_classes)
